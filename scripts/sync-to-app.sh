...
DEFAULT_PLUGINS=(omnimux omnimux-accounts omnimux-assets omnimux-products omnimux-gallery omnimux-workflow omnimux-market dsh-video omnimux-analytics)
...
build_one() {
  ...
  case "$name" in
    omnimux|omnimux-accounts|omnimux-assets|omnimux-products|omnimux-gallery)
