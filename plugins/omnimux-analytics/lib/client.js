...
var zh = {
  ...
  "filter.all": "\u5168\u90E8",
  "filter.account.main": "@omnimux_official\uFF08\u4E3B\u8D26\u53F7\uFF09",
...
var en = {
  ...
  "filter.all": "All",
  "filter.account.main": "@omnimux_official (primary)",
...
function createStageStore(stageId, getStage = () => typeof window !== "undefined" ? window.__omnimuxStage : void 0) {
  ...
  function emit2() {
    for (const listener of listeners2) try {
      listener();
    } catch (err) {
...
function useAnalyticsStore() {
  ...
  const setQueryStable = (0, import_react2.useCallback)((patch, opts) => setQuery(patch, opts), []);
  const refreshStable = (0, import_react2.useCallback)(() => refresh(), []);
  const syncNowStable = (0, import_react2.useCallback)(() => syncNow2(), []);
  const loadStable = (0, import_react2.useCallback)((query, opts) => loadDashboard(query, opts), []);
  const setThemeStable = (0, import_react2.useCallback)((theme) => setTheme(theme), []);
  return {
    ...snap,
