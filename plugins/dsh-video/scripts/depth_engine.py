#!/usr/bin/env python3
"""
depth_engine.py - Grayscale video depth map engine for dsh-video
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description="dsh-video Depth Anything V2 grayscale depth engine")
