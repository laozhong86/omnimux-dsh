      ...
      <section className="omnimux-publish-control-bar">
        <FilterBar
          ...
          filters={[
            ...
            >
              {t('tab.drafts')}
              {counts.draft > 0 ? <span className="omnimux-publish-tab-badge">{counts.draft}</span> : null}
            </Button>,
            <Button
              key="reviewing"
            ...
            >
              {t('tab.reviewing')}
              {counts.reviewing > 0 ? <span className="omnimux-publish-tab-badge">{counts.reviewing}</span> : null}
            </Button>,
            <Button
              key="published"
            ...
            >
              {t('tab.retry')}
              {counts.failed > 0 ? <span className="omnimux-publish-tab-badge retry">{counts.failed}</span> : null}
            </Button>,
          ]}
          tools={[
            <SearchField
