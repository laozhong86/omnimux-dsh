...
import { clearMarketplaceConnectorMemos, listMarketplaceConnectors, MARKETPLACE_ICON_SCHEME, marketplaceListMemoSize, marketplaceManifestPath, resolveMarketplaceIconFile, resolveMarketplaceIconUrl, sanitizeMarketplaceIconId, } from '../marketplace-connectors.js';
function writeManifest(root, connectors) {
...
function writeIcon(root, id, ext = '.png') {
