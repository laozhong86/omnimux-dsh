...
\u955C\u59343\uFF1A\u7279\u5199\uFF0C\u684C\u4E0A\u7684\u8001\u5F0F\u9ED1\u767D\u7167\u7247\uFF08\u9759\u6B62 2s\uFF09`),M({content:re,prompt:re,status:re.trim()?"ready":"empty",generatedContent:void 0})}},[n,M]),Z=(0,Ye.useCallback)(X=>{let re=URL.createObjectURL(X);if(X.type.startsWith("image/")){let ce=new Image;ce.src=re,ce.onload=()=>{ce.naturalWidth>0&&ce.naturalHeight>0&&E(ce.naturalWidth,ce.naturalHeight)}}else if(X.type.startsWith("video/")){let ce=document.createElement("video");ce.src=re,ce.onloadedmetadata=()=>{ce.videoWidth>0&&ce.videoHeight>0&&E(ce.videoWidth,ce.videoHeight)}}M({mediaUrl:re,status:"ready",content:X.name})},[E,M]),Q=(0,Ye.useCallback)(X=>{X.preventDefault(),X.stopPropagation(),g(!0)},[]),ae=(0,Ye.useCallback)(X=>{X.preventDefault(),X.stopPropagation(),g(!1)},[]),$=(0,Ye.useCallback)(X=>{X.preventDefault(),X.stopPropagation(),g(!1);let re=X.dataTransfer.files?.[0];re&&Z(re)},[Z]),H=(0,Ye.useCallback)(()=>{T&&navigator.clipboard.writeText(T).catch(()=>{})},[T]),K=(0,Ye.useCallback)(()=>{if(!T)return;let X=T.split(`

`).filter(re=>re.trim().length>0);X.length>1&&M({content:X.join(`
---
`)})},[T,M]);(0,Ye.useEffect)(()=>{a||(y(!1),S(!1))},[a]);let se=cL(a,p,f),ie=ii(n,m,s),ee=fL(f,r,!!ie),oe=n==="video"?"video":n==="audio"?"audio":"square";return(0,Ae.jsxs)("div",{className:`wf-material-node ${a?"wf-material-node--selected":""}`,style:{width:A},onMouseEnter:()=>w(!0),onMouseLeave:()=>w(!1),children:[(b||a)&&(0,Ae.jsx)(bL,{materialType:n,selected:a,onImportFile:Z,onStartTextEdit:()=>S(!0),onCopyText:H,onSplitText:K}),(0,Ae.jsx)(Eh,{side:"left",nodeHovered:b}),(0,Ae.jsx)(gL,{label:l,materialType:n,onLabelChange:X=>M({label:X}),trailing:(0,Ae.jsx)(hL,{executionStatus:f,status:r})}),(0,Ae.jsxs)("div",{className:`wf-material-node__card ${h?"wf-material-node__card--dragover":""}`,style:{width:A,height:L},onDragOver:Q,onDragLeave:ae,onDrop:$,children:[a&&(0,Ae.jsxs)(Ae.Fragment,{children:[(0,Ae.jsx)("span",{className:"wf-node-corner wf-node-corner--tl"}),(0,Ae.jsx)("span",{className:"wf-node-corner wf-node-corner--tr"}),(0,Ae.jsx)("span",{className:"wf-node-corner wf-node-corner--bl"}),(0,Ae.jsx)("span",{className:"wf-node-corner wf-node-corner--br"})]}),n==="text"&&(0,Ae.jsx)("div",{className:"wf-material-node__text-shell",style:{padding:"12px 14px"},children:T||C?(0,Ae.jsx)("textarea",{className:`wf-material-node__text-editor nowheel${C?" nodrag":""}`,readOnly:!C,value:T,placeholder:D("node.textPlaceholder"),autoFocus:C,onMouseDown:X=>{C||X.preventDefault()},onDoubleClick:X=>{X.stopPropagation(),S(!0),X.currentTarget.focus()},onFocus:()=>S(!0),onBlur:()=>S(!1),onChange:X=>M({content:X.target.value,status:X.target.value.trim()?"ready":"empty",generatedContent:void 0})}):(0,Ae.jsx)(_f,{materialType:"text",onStartEdit:()=>S(!0),onApplyPreset:Y})}),n!=="text"&&(ee?(0,Ae.jsx)("div",{className:"wf-material-node__media",children:(0,Ae.jsx)(dL,{status:ee,loadingAspectRatio:oe,errorMessage:d??c,taskId:o.taskId,onRetry:k,children:ie?(0,Ae.jsx)(xL,{materialType:n,mediaAssets:m,mediaUrl:s,label:l,onMediaSizeChange:E}):(0,Ae.jsx)(_f,{materialType:n,onApplyPreset:Y})})}):(0,Ae.jsx)("div",{className:"wf-material-node__media",children:(0,Ae.jsx)(_f,{materialType:n,onApplyPreset:Y})})),n==="text"&&(c||d)&&(0,Ae.jsx)("div",{className:"wf-material-node__error",children:d??c})]}),se&&(0,Ae.jsx)(SL,{onClose:()=>y(!0),children:(0,Ae.jsx)(zL,{nodeId:e,nodeData:o,catalog:x,onUpdateNodeData:M,onGenerate:k,execBusy:N})}),(0,Ae.jsx)(Eh,{side:"right",nodeHovered:b,options:F,onSelect:V})]})},OL=(0,Ye.memo)(e8);var BL={type:"material",component:OL,ports:[{side:"in",acceptedTypes:["text","image","video","audio"]},{side:"out",acceptedTypes:["text","image","video","audio"]}],defaultData:()=>sf("text",{status:"empty",nodeWidth:ri("text")}),configSpec:{promptEnabled:!0,modelCategory:"text"},executorKey:"material",palette:{group:"palette.group.material",label:"palette.node.material",icon:"box"}};var Nt=U(J(),1);iL(BL);var t8=sL(),a8={animated:zS},PL={maxZoom:1},o8={x:0,y:0,zoom:1},n8=[1,2],r8=96,l8=({catalog:e,onExecuteNodeIds:t,onStartExecution:a,onPauseExecution:o,onResumeExecution:n,onCancelExecution:r,onResetExecution:l})=>{let{screenToFlowPosition:i,fitView:s,zoomTo:u}=ma(),{nodes:c,edges:f,onNodesChange:d,onEdgesChange:m}=CS(),x=he(W=>W.applyCanvasInputMutation),b=he(W=>W.setNodes),w=he(W=>W.setSelectedElement),h=he(W=>W.pushHistory),g=he(W=>W.undo),p=he(W=>W.redo),y=SS(),C=LS(),[S,v]=(0,Ze.useState)(null),[_,I]=(0,Ze.useState)(!1),[N,A]=(0,Ze.useState)(!1),[B,P]=(0,Ze.useState)(!1),[L,M]=(0,Ze.useState)(!1),[E,k]=(0,Ze.useState)(void 0),[D,R]=(0,Ze.useState)("select"),F=(0,Ze.useRef)(0),V=(0,Ze.useMemo)(()=>c.some(W=>W.selected),[c]),T=nL(b,w),Y=Ce(),Z=Y("menu.generateFromNode"),{menuState:Q,onConnectStart:ae,onConnectEnd:$,onMenuSelect:H,onMenuClose:K}=eL({onReject:v});(0,Ze.useEffect)(()=>{h()},[c,f,h]);let se=(0,Ze.useMemo)(()=>e?c.map(W=>({...W,data:{...W.data,__catalog:e}})):c,[c,e]),ie=(0,Ze.useCallback)(W=>{let Re=x({addEdges:[W]});if(Re.status==="rejected"){let Ke=Y(wf(Re.reasonCode));v(Ke),ai.warning(Ke)}else v(null)},[x,Y]),ee=(0,Ze.useCallback)(W=>{let Re=he.getState();return ZS(W,Re.nodes,Re.edges)},[]),oe=(0,Ze.useCallback)((W,Re)=>{let Ke=F.current,Ba=Re??{x:120+Ke%3*420,y:120+Math.floor(Ke/3)*360},Zn=Br(W,Ba);Zn.nodes.length!==0&&(F.current+=1,b(Kn=>$S(Kn,Zn.nodes)))},[b]),xe=(0,Ze.useCallback)(W=>{let Re=W.nodes.map(Ba=>Ba.id),Ke=W.edges.map(Ba=>Ba.id);Re.length===0&&Ke.length===0||x({removeNodeIds:Re,removeEdgeIds:Ke})},[x]),{menu:X,handleNodeContextMenu:re,handlePaneContextMenu:ce,handleSelectionContextMenu:dt,closeMenu:bt,handleMenuAction:Dt,handleAddNodeFromMenu:Oa}=rL({screenToFlowPosition:i,setNodes:b,copySelectedNodes:T.copySelectedNodes,pasteNodes:T.pasteNodes,duplicateSelectedNodes:T.duplicateSelectedNodes,deleteSelectedNodes:T.deleteSelectedNodes,selectAllNodes:T.selectAllNodes,clearSelection:T.clearSelection,undo:g,redo:p,onExecuteNodeIds:t,onAddNode:oe}),Yn=(0,Ze.useCallback)(W=>{let Re=W.type==="video"?"video":W.type==="image"?"image":"text",Ke=F.current++,Ba={x:200+Ke%4*50,y:200+Ke%4*40},Kn=Br(Re,Ba,{title:W.name,content:W.path,previewUrl:W.previewUrl,status:"ready"}).nodes[0];Kn&&(x({addNodes:[Kn]}),w("node",Kn.id),ai.success(Y("toolbar.assets")+": "+W.name))},[x,w,Y]);YS({onCopy:T.copySelectedNodes,onPaste:()=>T.pasteNodes(),onSelectAll:T.selectAllNodes,onDeleteSelected:T.deleteSelectedNodes,onClearSelection:T.clearSelection,onDuplicate:T.duplicateSelectedNodes,onUndo:g,onRedo:p,hasSelection:V,onToggleAssets:()=>A(W=>!W),onToggleShortcuts:()=>P(W=>!W),onToggleMinimap:()=>I(W=>!W),onToggleAddMenu:()=>M(W=>!W),onSetPointerMode:W=>R(W),onFitView:()=>s(PL),onResetZoom:()=>u(1),onCategoryKey:W=>{A(!0),k(W)}});let bo=(0,Ze.useCallback)((W,Re)=>{w("node",Re.id)},[w]),wo=(0,Ze.useCallback)(()=>{w("none",null),bt()},[w,bt]),aa=(0,Ze.useCallback)(()=>{b(W=>W.map((Re,Ke)=>({...Re,position:{x:120+Ke%3*440,y:120+Math.floor(Ke/3)*360}})))},[b]);return(0,Nt.jsxs)("div",{className:"wf-canvas-editor",style:{position:"relative",height:"100%"},children:[(0,Nt.jsx)(B2,{nodes:se,edges:f,onNodesChange:d,onEdgesChange:m,onConnect:ie,isValidConnection:ee,onConnectStart:ae,onConnectEnd:$,onNodeClick:bo,onPaneClick:wo,onNodeContextMenu:re,onPaneContextMenu:ce,onSelectionContextMenu:dt,onDelete:xe,nodeTypes:t8,edgeTypes:a8,fitView:!0,fitViewOptions:PL,defaultViewport:o8,minZoom:Lh.minZoom,maxZoom:Lh.maxZoom,selectionKeyCode:null,multiSelectionKeyCode:"Meta",panOnDrag:D==="pan"?!0:n8,panOnScroll:!0,panOnScrollMode:Ga.Free,zoomOnScroll:!0,zoomOnPinch:!0,selectionOnDrag:D==="select",selectionMode:Xo.Partial,defaultEdgeOptions:lf,connectOnClick:!1,connectionRadius:r8,onlyRenderVisibleElements:!0,children:(0,Nt.jsx)(q2,{color:"var(--wb-grid-dot, #C9CBD6)",gap:48,size:3.5,variant:uo.Dots})}),(0,Nt.jsx)(BS,{isMinimapOpen:_,onToggleMinimap:()=>I(W=>!W),onAlignGrid:aa,onStartExecution:a,onPauseExecution:o,onResumeExecution:n,onCancelExecution:r,onResetExecution:l}),_&&(0,Nt.jsx)("div",{className:"wf-minimap-popover nodrag nopan",children:(0,Nt.jsx)(G2,{pannable:!0,zoomable:!0})}),(0,Nt.jsx)(OS,{onAddNode:oe,onUndo:g,onRedo:p,canUndo:y,canRedo:C,pointerMode:D,onPointerModeChange:R,onToggleAssets:()=>A(W=>!W),onToggleShortcuts:()=>P(W=>!W),isAssetsOpen:N,isShortcutsOpen:B,isAddMenuOpen:L,onToggleAddMenu:()=>M(W=>!W)}),(0,Nt.jsx)(PS,{isOpen:N,onClose:()=>A(!1),onInsertAsset:Yn,selectedCategoryIndex:E}),(0,Nt.jsx)(HS,{isOpen:B,onClose:()=>P(!1)}),(0,Nt.jsx)(GS,{x:X.x,y:X.y,visible:X.visible,context:X.context,onClose:bt,onAction:Dt,onAddNode:Oa,canUndo:y,canRedo:C,hasClipboard:T.hasClipboard,hasSelection:V}),(0,Nt.jsx)(bf,{visible:Q.visible,x:Q.x,y:Q.y,title:Z,options:Q.options,onSelect:H,onClose:K}),S&&(0,Nt.jsx)("div",{className:"wf-rejected-toast",children:S})]})},i8=e=>(0,Nt.jsx)(fh,{children:(0,Nt.jsx)(l8,{...e})}),HL=i8;var rt=U(ne(),1);var Ja="/omnimux-workflow";var xa={manifest:`${Ja}/api/manifest`,canvasJs:`${Ja}/canvas.js`,workspaces:`${Ja}/api/workspaces`,workspace:e=>`${Ja}/api/workspaces/${e}`,workspaceVersion:e=>`${Ja}/api/workspaces/${e}/version`,capabilities:`${Ja}/api/capabilities`,media:`${Ja}/media`,executions:e=>`${Ja}/api/workspaces/${e}/executions`,execution:(e,t)=>`${Ja}/api/workspaces/${e}/executions/${t}`,executionAction:(e,t,a)=>`${Ja}/api/workspaces/${e}/executions/${t}/${a}`,executionEvents:(e,t)=>`${Ja}/api/workspaces/${e}/executions/${t}/events`};async function yo(e,t={}){let a=await fetch(e,{method:t.method??"GET",headers:t.body===void 0?void 0:{"Content-Type":"application/json"},body:t.body===void 0?void 0:JSON.stringify(t.body)}),o={};try{o=await a.json()}catch{o={error:`HTTP ${String(a.status)}`}}return{ok:a.ok,status:a.status,body:o}}function UL(){return yo(xa.capabilities)}function qL(){return yo(xa.workspaces)}function Nh(e,t){return yo(xa.workspaces,{method:"POST",body:{name:e,id:t}})}function Cu(e){return yo(xa.workspace(encodeURIComponent(e)))}function FL(e){return yo(xa.workspaceVersion(encodeURIComponent(e)))}function VL(e,t){return yo(xa.workspace(encodeURIComponent(e)),{method:"PUT",body:t})}function GL(e,t={}){return yo(xa.executions(encodeURIComponent(e)),{method:"POST",body:t})}function XL(e){return yo(xa.executions(encodeURIComponent(e)))}function YL(e,t){return yo(xa.execution(encodeURIComponent(e),encodeURIComponent(t)))}function ZL(e,t,a){return yo(xa.executionAction(encodeURIComponent(e),encodeURIComponent(t),a),{method:"POST",body:{}})}var KL=new Set(["pending","running","paused"]),s8=new Set(["completed","error","cancelled"]);function Su(e,t){let a=he.getState();a.nodes.find(n=>n.id===e)&&a.setNodes(n=>n.map(r=>r.id===e?{...r,data:{...r.data,...t}}:r))}function jL(e,t){let a=(0,rt.useRef)(null),o=(0,rt.useRef)(e);o.current=e;let n=(0,rt.useRef)(t?.onBeforeStart);n.current=t?.onBeforeStart;let r=(0,rt.useCallback)(()=>{a.current&&(a.current.close(),a.current=null)},[]),l=(0,rt.useCallback)((w,h)=>{Fe.getState().setExecution({status:w,error:h,progress:{...Fe.getState().progress,percentage:w==="completed"?100:Fe.getState().progress.percentage}})},[]),i=(0,rt.useCallback)((w,h)=>{let g;try{g=JSON.parse(h)}catch{return}let p=Fe.getState();switch(w){case"execution_start":{p.setExecution({status:"running",error:null,progress:{total:g.totalNodes??0,completed:0,running:0,pending:g.totalNodes??0,percentage:0}});break}case"node_start":{if(!g.nodeId)break;p.setNodeStatus(g.nodeId,"running"),p.setExecution({progress:{...p.progress,running:p.progress.running+1,pending:Math.max(0,p.progress.pending-1)}}),Su(g.nodeId,{executionStatus:"running",executionError:void 0});break}case"node_complete":{if(!g.nodeId)break;p.setNodeStatus(g.nodeId,"completed"),p.setExecution({progress:{...p.progress,completed:p.progress.completed+1,running:Math.max(0,p.progress.running-1),percentage:g.progress??p.progress.percentage}});let y=g.output??{},C={executionStatus:"completed",executionError:void 0};if(y.text&&(C.generatedContent=y.text),y.mediaAssets&&y.mediaAssets.length>0){let S=y.mediaAssets[0];C.mediaAssets=y.mediaAssets,S.type==="image"&&(C.mediaUrl=S.url),C.taskId=`exec-${g.executionId??""}`}Su(g.nodeId,C);break}case"node_error":{if(!g.nodeId)break;p.setNodeStatus(g.nodeId,"error"),p.setExecution({progress:{...p.progress,running:Math.max(0,p.progress.running-1)}}),Su(g.nodeId,{executionStatus:"error",executionError:g.error??Zo("error.nodeExecutionFailed")});break}case"node_skipped":{if(!g.nodeId)break;p.setNodeStatus(g.nodeId,"skipped"),Su(g.nodeId,{executionStatus:"skipped",executionError:void 0});break}case"execution_paused":{p.setExecution({status:"paused"});break}case"execution_resumed":{p.setExecution({status:"running"});break}case"execution_complete":{l("completed",null),r();break}case"execution_error":{l("error",g.error??Zo("error.executionFailed")),r();break}case"execution_cancelled":{l("cancelled",null),r();break}default:break}},[l,r]),s=(0,rt.useCallback)(w=>{r();let h=o.current;if(!h)return;let g=new EventSource(xa.executionEvents(encodeURIComponent(h),encodeURIComponent(w)));a.current=g;let p=["execution_start","node_start","node_progress","node_complete","node_error","node_skipped","execution_paused","execution_resumed","execution_complete","execution_error","execution_cancelled"];for(let y of p)g.addEventListener(y,C=>{i(y,C.data)});g.onerror=()=>{let y=Fe.getState().status;s8.has(y)&&r()}},[r,i]),u=(0,rt.useCallback)(w=>{let h=Fe.getState();h.setExecution({executionId:w.id,status:w.status,error:w.error,progress:{total:w.progress.total,completed:w.progress.completed,running:w.progress.running,pending:w.progress.pending,percentage:w.progress.percentage}});for(let[g,p]of Object.entries(w.nodeStates??{})){h.setNodeStatus(g,p.status);let y={executionStatus:p.status};p.status==="error"&&p.error&&(y.executionError=p.error);let C=w.nodeOutputs?.[g];C&&(C.text&&(y.generatedContent=C.text),C.mediaAssets&&C.mediaAssets.length>0&&(y.mediaAssets=C.mediaAssets,C.mediaAssets[0]&&C.mediaAssets[0].type==="image"&&(y.mediaUrl=C.mediaAssets[0].url))),Su(g,y)}},[]),c=(0,rt.useCallback)(async(w={})=>{let h=o.current;if(!h)return;if(r(),Fe.getState().resetExecution(),Fe.getState().setExecution({status:"pending"}),n.current)try{await n.current()}catch{}let g=await GL(h,{mode:w.mode??"full",nodeIds:w.nodeIds});if(!g.ok||!g.body.execution){Fe.getState().setExecution({status:"error",error:g.body.message??Zo("error.createExecutionFailed")});return}Fe.getState().setExecution({executionId:g.body.execution.id}),s(g.body.execution.id)},[r,s]),f=(0,rt.useCallback)(async w=>{let h=o.current,{executionId:g}=Fe.getState();if(!h||!g)return;let p=await ZL(h,g,w);!p.ok&&p.body.message&&Fe.getState().setExecution({error:p.body.message})},[]),d=(0,rt.useCallback)(()=>f("pause"),[f]),m=(0,rt.useCallback)(()=>f("resume"),[f]),x=(0,rt.useCallback)(()=>f("cancel"),[f]),b=(0,rt.useCallback)(()=>{r(),Fe.getState().resetExecution()},[r]);return(0,rt.useEffect)(()=>{if(!e)return;let w=!1;return(async()=>{try{let h=await XL(e);if(w||!h.ok)return;let g=(h.body.executions??[]).find(y=>KL.has(y.status));if(!g)return;let p=await YL(e,g.id);if(w||!p.ok||!p.body.execution)return;u(p.body.execution),KL.has(p.body.execution.status)&&s(g.id)}catch{}})(),()=>{w=!0}},[e,u,s]),(0,rt.useEffect)(()=>(Fe.getState().setStartNodeExecution(h=>{c({mode:"subset",nodeIds:[h]})}),()=>{Fe.getState().setStartNodeExecution(null)}),[c]),(0,rt.useEffect)(()=>r,[r]),{startExecution:c,pause:d,resume:m,cancel:x,reset:b}}var Ur=U(ne(),1);function WL(e={}){let t=e.workspaceId,[a,o]=(0,Ur.useState)({phase:"loading"}),[n,r]=(0,Ur.useState)(()=>vu()),l=he(c=>c.hydrateGraph),i=he(c=>c.resetStore),s=he(c=>c.nodes.length),u=(0,Ur.useRef)(e.beforeReset);return u.current=e.beforeReset,(0,Ur.useEffect)(()=>{let c=!1;return o({phase:"loading"}),(async()=>{try{if(UL().then(x=>{!c&&x.ok&&(r(x.body),EL(x.body))}),t){let x=await Cu(t);if(c)return;if(x.ok&&x.body.workspace){l(x.body.workspace.nodes,x.body.workspace.edges),o({phase:"ready",workspace:x.body.workspace});return}let b=await Nh("\u5DE5\u4F5C\u6D41",t);if(c)return;if(!b.ok||!b.body.workspace)throw new Error(b.body.message??Zo("error.createWorkspaceFailed"));l(b.body.workspace.nodes,b.body.workspace.edges),o({phase:"ready",workspace:b.body.workspace});return}let f=await qL();if(c)return;let d=f.body.workspaces?.[0]?.id;if(!d){let x=await Nh("\u6211\u7684\u5DE5\u4F5C\u6D41");if(c)return;if(!x.ok||!x.body.workspace)throw new Error(x.body.message??Zo("error.createWorkspaceFailed"));d=x.body.workspace.id}let m=await Cu(d);if(c)return;if(!m.ok||!m.body.workspace)throw new Error(m.body.message??Zo("error.loadWorkspaceFailed"));l(m.body.workspace.nodes,m.body.workspace.edges),o({phase:"ready",workspace:m.body.workspace})}catch(f){c||o({phase:"error",message:f instanceof Error?f.message:String(f)})}})(),()=>{c=!0,u.current?.(),i()}},[t,l,i]),{boot:a,setBoot:o,catalog:n,nodeCount:s}}var Ve=U(ne(),1);function kf(e){return e&&typeof e=="object"&&!Array.isArray(e)?{...e}:{}}function Dh(e){return e.map(t=>{let a=t,o=kf(a.data);delete o.__catalog;let n={id:a.id,type:a.type,position:a.position,data:o,selected:!1};return typeof a.draggable=="boolean"&&(n.draggable=a.draggable),typeof a.selectable=="boolean"&&(n.selectable=a.selectable),typeof a.deletable=="boolean"&&(n.deletable=a.deletable),typeof a.width=="number"&&(n.width=a.width),typeof a.height=="number"&&(n.height=a.height),typeof a.parentId=="string"&&(n.parentId=a.parentId),typeof a.zIndex=="number"&&(n.zIndex=a.zIndex),a.style&&typeof a.style=="object"&&(n.style=kf(a.style)),n})}function Rh(e){return e.map(t=>{let a=t,o={id:a.id,source:a.source,target:a.target};return a.sourceHandle!==void 0&&(o.sourceHandle=a.sourceHandle),a.targetHandle!==void 0&&(o.targetHandle=a.targetHandle),typeof a.type=="string"&&(o.type=a.type),typeof a.animated=="boolean"&&(o.animated=a.animated),a.data&&typeof a.data=="object"&&(o.data=kf(a.data)),a.style&&typeof a.style=="object"&&(o.style=kf(a.style)),o})}function Wo(e,t){return JSON.stringify({nodes:Dh(e),edges:Rh(t)})}var u8=1e3,d8=2500,c8=3e3;function di(){let{nodes:e,edges:t}=he.getState(),a=yh(e,t);return{nodes:a.nodes,edges:a.edges}}function QL(e,t={}){let a=t.enabled!==!1,[o,n]=(0,Ve.useState)("idle"),[r,l]=(0,Ve.useState)(!1),i=(0,Ve.useRef)(e),s=(0,Ve.useRef)(0),u=(0,Ve.useRef)(""),c=(0,Ve.useRef)(0),f=(0,Ve.useRef)(""),d=(0,Ve.useRef)(null),m=(0,Ve.useRef)(null),x=(0,Ve.useRef)(!1),b=(0,Ve.useRef)(a);b.current=a;let w=(0,Ve.useRef)(t.onSaved);w.current=t.onSaved,(0,Ve.useEffect)(()=>{i.current=e,e&&(s.current=e.version,f.current!==e.id&&(f.current=e.id,u.current=Wo(e.nodes,e.edges),c.current=e.nodes.length,l(!1),n("idle")))},[e?.id,e?.version]);let h=()=>{m.current&&(clearTimeout(m.current),m.current=null)},g=(0,Ve.useCallback)(async(v,_,I=!1)=>{let N=i.current;if(!N||!I&&!b.current||x.current)return;let A=mf({lastSavedNodeCount:c.current,nextNodes:v.nodes,nextEdges:v.edges,cause:_,lastSavedSignature:u.current,nextSignature:Wo(v.nodes,v.edges)});if(!A.persist||!A.snapshot)return;let{nodes:B,edges:P}=A.snapshot,L=N.name;x.current=!0,n("saving");try{let M=await VL(N.id,{name:L,nodes:Dh(B),edges:Rh(P),expectedVersion:s.current});if(M.status===409){typeof M.body.current=="number"&&(s.current=M.body.current),n("conflict");return}M.ok&&M.body.workspace?(s.current=M.body.workspace.version,u.current=Wo(B,P),c.current=B.length,l(!1),n("saved"),h(),m.current=setTimeout(()=>{n(E=>E==="saved"?"idle":E)},d8),w.current?.(M.body.workspace)):M.status===409?n("conflict"):n("error")}catch{n("error")}finally{x.current=!1}},[]);(0,Ve.useEffect)(()=>{if(!a)return;let v=(I="autosave")=>{if(!i.current||!b.current)return;let A=di(),P=Wo(A.nodes,A.edges)!==u.current;if(l(P),!P){d.current&&(clearTimeout(d.current),d.current=null),n(k=>k==="pending"?"idle":k);return}let L=xu(A.nodes.length,I);if(!xh({lastSavedNodeCount:c.current,nextNodeCount:A.nodes.length,cause:L})){d.current&&(clearTimeout(d.current),d.current=null),l(!1),n(k=>k==="pending"?"idle":k);return}n(k=>k==="saving"||k==="conflict"?k:"pending"),d.current&&clearTimeout(d.current);let M={nodes:A.nodes,edges:A.edges},E=L;d.current=setTimeout(()=>{d.current=null,g(M,E)},u8)},_=he.subscribe(()=>{v("autosave")});return()=>{_(),d.current&&(clearTimeout(d.current),d.current=null)}},[g,a]),(0,Ve.useEffect)(()=>{if(!a)return;let v=()=>{if(!b.current||!i.current)return;let I=di(),N=xu(I.nodes.length,"flush"),A=mf({lastSavedNodeCount:c.current,nextNodes:I.nodes,nextEdges:I.edges,cause:N,lastSavedSignature:u.current,nextSignature:Wo(I.nodes,I.edges)});!A.persist||!A.snapshot||g(A.snapshot,N)};return window.addEventListener("pagehide",v),()=>{window.removeEventListener("pagehide",v),v(),h()}},[g,a]);let p=(0,Ve.useCallback)(async()=>{d.current&&(clearTimeout(d.current),d.current=null);let v=di();await g(v,xu(v.nodes.length,"autosave"))},[g]),y=(0,Ve.useCallback)(()=>{if(d.current&&(clearTimeout(d.current),d.current=null),!i.current)return;let _=di(),I="flush",N=mf({lastSavedNodeCount:c.current,nextNodes:_.nodes,nextEdges:_.edges,cause:I,lastSavedSignature:u.current,nextSignature:Wo(_.nodes,_.edges)});!N.persist||!N.snapshot||g(N.snapshot,I,!0)},[g]),C=(0,Ve.useCallback)(async()=>{let v=di();await g(v,xu(v.nodes.length,"autosave"))},[g]),S=(0,Ve.useCallback)(async()=>{let v=i.current;if(!v)return;let _=await Cu(v.id);if(!_.ok||!_.body.workspace){n("error");return}let I=_.body.workspace;s.current=I.version,u.current=Wo(I.nodes,I.edges),c.current=I.nodes.length,he.getState().hydrateGraph(I.nodes,I.edges),l(!1),n("idle"),w.current?.(I)},[]);return(0,Ve.useEffect)(()=>{if(!a)return;let v=!1,_=async()=>{if(v||!b.current||typeof document<"u"&&document.visibilityState==="hidden")return;let N=i.current;if(!(!N||x.current)){v=!0;try{let A=await FL(N.id);if(!A.ok||typeof A.body.version!="number"||A.body.version<=s.current)return;let B=di();if(Wo(B.nodes,B.edges)!==u.current){s.current=A.body.version,n("conflict");return}await S()}catch{}finally{v=!1}}},I=setInterval(()=>{_()},c8);return()=>clearInterval(I)},[a,S]),{status:o,isDirty:r,saveNow:p,flushPendingSave:y,resolveConflict:C,reloadFromServer:S}}var Ft=U(J(),1),f8=({locale:e,workspaceId:t})=>{let a=Ce(),o=(0,ci.useRef)(()=>{}),{boot:n,setBoot:r,catalog:l}=WL({workspaceId:t,beforeReset:()=>{o.current()}});(0,ci.useEffect)(()=>{DS(e)},[e]);let i=n.phase==="ready"?n.workspace:null,s=(0,ci.useCallback)(f=>{r(d=>d.phase==="ready"?{phase:"ready",workspace:f}:d)},[r]),u=QL(i,{onSaved:s,enabled:n.phase==="ready"});o.current=u.flushPendingSave;let c=jL(i?i.id:null,{onBeforeStart:u.saveNow});return n.phase==="loading"?(0,Ft.jsx)("div",{className:"wf-canvas-root",children:(0,Ft.jsx)("div",{style:{flex:1,display:"flex",alignItems:"center",justifyContent:"center",fontSize:13,color:"var(--wb-text-muted)"},children:a("app.loading")})}):n.phase==="error"?(0,Ft.jsx)("div",{className:"wf-canvas-root",children:(0,Ft.jsxs)("div",{style:{flex:1,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:10,fontSize:13,color:"var(--wb-text-muted)"},children:[(0,Ft.jsx)("span",{children:n.message}),(0,Ft.jsx)("button",{type:"button",className:"wf-canvas-header__button",onClick:()=>window.location.reload(),children:a("app.retry")})]})}):(0,Ft.jsxs)("div",{className:"wf-canvas-root",children:[u.status==="conflict"?(0,Ft.jsxs)("div",{className:"wf-canvas-conflict-banner",role:"alert",children:[(0,Ft.jsx)("span",{children:a("app.conflictBanner")}),(0,Ft.jsx)("button",{type:"button",className:"wf-canvas-header__button",onClick:()=>{u.resolveConflict()},children:a("app.conflictOverwrite")}),(0,Ft.jsx)("button",{type:"button",className:"wf-canvas-header__button wf-canvas-header__button--ghost",onClick:()=>{u.reloadFromServer()},children:a("app.conflictReload")})]}):null,(0,Ft.jsx)("main",{className:"wf-canvas-main",children:(0,Ft.jsx)(HL,{catalog:l,onExecuteNodeIds:f=>{c.startExecution({mode:"subset",nodeIds:f})},onStartExecution:()=>{c.startExecution({mode:"full"})},onPauseExecution:()=>{c.pause()},onResumeExecution:()=>{c.resume()},onCancelExecution:()=>{c.cancel()},onResetExecution:c.reset})})]})},zh=f8;var $L=`/* this gets exported as style.css and can be used for the default theming */
