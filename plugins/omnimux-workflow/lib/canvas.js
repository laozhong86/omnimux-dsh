...
`;var l7=[{id:"omnimux-workflow-xyflow-base",css:SN},{id:"omnimux-workflow-theme",css:kN},{id:"omnimux-workflow-components",css:LN},{id:"omnimux-workflow-table-node",css:_N}];function IN(){for(let{id:e,css:t}of l7){let a=document.getElementById(e);if(a instanceof HTMLStyleElement)a.textContent!==t&&(a.textContent=t);else{let o=document.createElement("style");o.id=e,o.textContent=t,document.head.append(o)}}}var bw=N(j(),1),ef=new WeakMap;function s7(e,t){if(!e||ef.has(e))return;IN();let a=(0,MN.createRoot)(e);ef.set(e,{root:a,lastProps:t}),a.render((0,bw.jsx)(xw,{...t}))}function d7(e,t){let a=ef.get(e);a&&(a.lastProps=t,a.root.render((0,bw.jsx)(xw,{...t})))}function u7(e){let t=ef.get(e);t&&(t.root.unmount(),ef.delete(e))}return o3(c7);})();
