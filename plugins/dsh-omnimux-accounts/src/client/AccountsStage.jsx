...
// (plugins/dsh-omnimux/src/client/open-app.js and conversation-box.js). This
...
const APP_OPEN_EVENT = 'dsh-omnimux-app-open'
 ...
 * (plugins/dsh-omnimux/src/client/conversation-box.js); first-level product
 ...
 * `dsh-omnimux-app-open` with detail.id 'accounts'; this stage claims the
