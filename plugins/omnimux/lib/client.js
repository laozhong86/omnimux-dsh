...
function readConversationBox() {
  ...
  if (found) {
    const winWidth2 = typeof window !== "undefined" && typeof window.innerWidth === "number" ? window.innerWidth : 0;
    const winHeight2 = typeof window !== "undefined" && typeof window.innerHeight === "number" ? window.innerHeight : 0;
    const width = winWidth2 > found.left ? Math.max(found.width, winWidth2 - found.left) : found.width;
    const height = winHeight2 > found.top ? Math.max(found.height, winHeight2 - found.top) : found.height;
