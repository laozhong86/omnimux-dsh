export const zh = {
  ...
  'composerAdd.runtimeUpdateRequired': '添加文件和从资产库添加需要更新 DeepSeek Harness 运行时后可用。',
...
export const en = {
  ...
  'composerAdd.runtimeUpdateRequired': 'Update the DeepSeek Harness runtime to add files or assets from the library.',
