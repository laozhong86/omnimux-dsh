/**
 * Self-implemented product-stage plumbing (equivalent copy of the hub's
 * conversation-box.js, with ids isolated so nothing imports the hub).
 */
 ...
 * so the hub's `dshSessionCloser` and ours never double-register.
 */
