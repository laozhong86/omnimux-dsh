...
supersedes: []
superseded_by: "docs/decisions/2026-08-31-workbench-libraries-and-toggle.md"
related:
...
> **权威等级**：L2 | **状态**：`accepted`（**第 1 条后半已修订**） | **生效日期**：2026-08-31  
> **修订**：库/目录页继续 `shell.overlay` 的条款已被 [2026-08-31-workbench-libraries-and-toggle](./2026-08-31-workbench-libraries-and-toggle.md) 替代。其余裁定（不发明三栏壳、不卸载 conversation、无 better-sidebar 不回退 overlay、无当前会话不 `sessions.create`）仍有效。  
...
1. **不发明三栏壳**。工作台坐社区 `dsh-better-sidebar`。~~库/目录页继续 `shell.overlay` + `claimProductStage`。~~ **（2026-08-31 修订：库页已迁入右栏，见 [libraries-and-toggle](./2026-08-31-workbench-libraries-and-toggle.md)。）**
...
| ~~把库页也搬进右栏~~ | ~~产品未拍板~~ **已由 #318 / 2026-08-31-workbench-libraries-and-toggle 采纳** |
