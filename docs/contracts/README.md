...
| `living` | [briefing.md](briefing.md) | Briefing contract | `dsh-drama` | 2026-08-26 | Project briefing process. Memory, not truth. |
...
| `living` | [series.md](series.md) | series/ contract | `dsh-drama` | 2026-08-26 | Product store. Session logs are not this store. |
...
| `living` | [plugin-git-pr.md](plugin-git-pr.md) | plugin-git-pr — OmniMux 插件仓 Git / PR 合同 | `dsh-drama` | 2026-08-24 | \| 项 \| 值 \| |
...
| `living` | [dsh-video-plugin.md](dsh-video-plugin.md) | PRD：dsh-video 视频能力插件（自包含本地执行 + 理解层） | `dsh-drama` | 2026-08-22 | 状态：**Revised v2.1（2026-08-22：增补视频理解两工具；处理层仍为本机 ffmpeg）** |
...
| `living` | [hub.md](hub.md) | Execution hub | `dsh-drama` | 2026-08-16 | Normative I/O for `omnimux` and every vertical. Status of a live surface is capabilities.md. Rationa |
