...
│   (B. 分类过滤 Chip 胶囊)   [所有类型/全部]  角色  场景  风格包  道具  自定义                     │
│                                                                                             │
│   ────── 靠左：业务属性过滤 ──────                 ────── 靠右：工具簇 ──────              │
│                                                   [ 🔍 搜索输入框 (Pill) ] [ 排序下拉 ∨ ] [▦][☰]│
├─────────────────────────────────────────────────────────────────────────────────────────────┤
...
| **Layer 3B: 分类 Chips** | *(由 3A 承载)* | `[所有类型]` `角色` `场景` `风格包` `道具` `自定义` | `[全部]` `精选` `短剧漫剧` `专业影视` `动画` `商业广告` … | **单行 Filter Chips**：靠左排列，第一个为 `全部/所有类型`（浅灰底色胶囊高亮） |
