...
| `accepted` | [2026-08-23-omnimux-products.md](2026-08-23-omnimux-products.md) | OmniMux 产品库插件需求文档 | `omnimux-drama` | 2026-08-23 | 产品库是带货准备的**语义对象库**：一条产品 = 名称 + 怎么卖（卖点/人群/品牌/价格/SKU/链接）+ 可选主图引用。 |
...
| `accepted` | [2026-08-20-omnimux-login-gate.md](2026-08-20-omnimux-login-gate.md) | OmniMux 统一登录门 — 架构设计 | `omnimux-drama` | 2026-08-20 | - 作者：高见远（架构师） |
