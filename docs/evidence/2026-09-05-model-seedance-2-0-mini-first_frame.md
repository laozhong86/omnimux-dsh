---
title: "model evidence — seedance-2-0-mini#first_frame — 2026-09-05"
id: "evidence-model-seedance-2-0-mini-first_frame-20260905"
type: "evidence"
status: "accepted"
authority: "L3"
date: "2026-09-05"
...
# model evidence — seedance-2-0-mini#first_frame — 2026-09-05
...
## 2. minimal（最小生成）
- 最小输入：model=`seedance-2-0-mini` op=`first_frame`；prompt 固定短句；duration=4; resolution=720P; aspect_ratio=16:9；wire 字段=images[]
- 结果：submit HTTP 200; taskId `task_ztbp9FZefcjxI2mADo5EfklKCGEsfnRa`; terminal `success`; mode **live**; media bytes **1618252**; elapsedMs=181001
