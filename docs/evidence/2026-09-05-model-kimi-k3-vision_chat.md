---
title: "model evidence — kimi-k3#vision_chat — 2026-09-05"
id: "evidence-model-kimi-k3-vision_chat-20260905"
type: "evidence"
status: "accepted"
authority: "L3"
date: "2026-09-05"
...
# model evidence — kimi-k3#vision_chat — 2026-09-05
...
- 结果：HTTP 200；mode **live**；id `resp_pO4ZFHZHr8nJTVNe0YuCwanP`；usage prompt=115 completion=49 total=164；摘要 `Red`；6411ms
...
| reference_images | reference | 1 图 200 live（id `resp_pO4ZFHZHr8nJTVNe0YuCwanP`） | 2 图 200 live text=`2`；10 图 200 live text=`10`；**11 图仍 HTTP 200 live text=`11`，未触达拒绝点** | 上游未在 11 拒绝 → **不得写「最大 10 实测」**；契约 max:10 仅 `policy_conservative` |
