---
title: "model evidence — gemini-3.1-pro-preview#vision_chat — 2026-09-05"
id: "evidence-model-gemini-3.1-pro-preview-vision_chat-20260905"
type: "evidence"
status: "accepted"
authority: "L3"
date: "2026-09-05"
...
# model evidence — gemini-3.1-pro-preview#vision_chat — 2026-09-05
...
- 结果：HTTP 200；`gemini-3.1-pro-preview` **在列**
...
- 结果：HTTP 200；mode **live**；id `msg_01Fv7TiM7ffPR7FRlym6bwyC`；usage prompt=1102 completion=140 total=1242；摘要 `Red`；4529ms
...
| reference_images | reference | 1 图 200 live（id `msg_01Fv7TiM7ffPR7FRlym6bwyC`） | 2 图 200 live text=`2`；10 图 200 live text=`10`；**11 图仍 HTTP 200 live text=`11`，未触达拒绝点** | 上游未在 11 拒绝 → **不得写「最大 10 实测」**；契约 max:10 仅 `policy_conservative` |
