---
title: "model evidence — deepseek-v4-flash-vision-exp#vision_chat — 2026-09-05"
id: "evidence-model-deepseek-v4-flash-vision-exp-vision_chat-20260905"
type: "evidence"
status: "accepted"
authority: "L3"
date: "2026-09-05"
...
# model evidence — deepseek-v4-flash-vision-exp#vision_chat — 2026-09-05
...
- 结果：HTTP 200；`deepseek-v4-flash-vision-exp` **在列**
...
- 结果：HTTP 200；mode **live**；id `23df82ad-28ff-4474-8f86-4ddaad665040`；usage prompt=211 completion=44 total=255；摘要 `red`；1250ms
...
| reference_images | reference | 1 图 200 live（id `23df82ad-28ff-4474-8f86-4ddaad665040`） | 2 图 200 live text=`2`；10 图 200 live text=`10`；**11 图仍 HTTP 200 live text=`11`，未触达拒绝点** | 上游未在 11 拒绝 → **不得写「最大 10 实测」**；契约 max:10 仅 `policy_conservative` |
...
- 备注：**独立** vision-exp 探针（禁止继承 deepseek-v4-flash）；max_tokens 抬高后 PNG/JPEG/WebP 均识别 red；10/11 图均 200 且未拒。
