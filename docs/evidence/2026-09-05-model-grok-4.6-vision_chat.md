---
title: "model evidence — grok-4.6#vision_chat — 2026-09-05"
id: "evidence-model-grok-4.6-vision_chat-20260905"
type: "evidence"
status: "accepted"
authority: "L3"
date: "2026-09-05"
...
# model evidence — grok-4.6#vision_chat — 2026-09-05
...
- 结果：HTTP 200；mode **live**；id `babc6a30-944d-9d9e-908f-8cae5af1b95d`；usage prompt=213 completion=104 total=317；摘要 `Red`；2748ms
...
| reference_images | reference | 1 图 200 live（id `babc6a30-944d-9d9e-908f-8cae5af1b95d`） | 2 图 200 live text=`2`；10 图 200 live text=`10`；**11 图仍 HTTP 200 live text=`11`，未触达拒绝点** | 上游未在 11 拒绝 → **不得写「最大 10 实测」**；契约 max:10 仅 `policy_conservative` |
