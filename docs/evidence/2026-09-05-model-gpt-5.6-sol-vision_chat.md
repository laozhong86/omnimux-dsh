---
title: "model evidence — gpt-5.6-sol#vision_chat — 2026-09-05"
id: "evidence-model-gpt-5.6-sol-vision_chat-20260905"
type: "evidence"
status: "accepted"
authority: "L3"
date: "2026-09-05"
...
# model evidence — gpt-5.6-sol#vision_chat — 2026-09-05
...
- 结果：HTTP 200；mode **live**；id `resp_04c22668cdafb6d8016a9b7eda1fe487d0a0f71892b7ce7c32`；usage prompt=23 completion=5 total=28；摘要 `Red`；1996ms
...
| reference_images | reference | 1 图 200 live（id `resp_04c22668cdafb6d8016a9b7eda1fe487d0a0f71892b7ce7c32`） | 2 图 200 live text=`2`；10 图 200 live text=`10`；**11 图仍 HTTP 200 live text=`11`，未触达拒绝点** | 上游未在 11 拒绝 → **不得写「最大 10 实测」**；契约 max:10 仅 `policy_conservative` |
