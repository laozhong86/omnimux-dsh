---
title: "model evidence — gpt-5.5#vision_chat — 2026-09-05"
id: "evidence-model-gpt-5.5-vision_chat-20260905"
type: "evidence"
status: "accepted"
authority: "L3"
date: "2026-09-05"
...
# model evidence — gpt-5.5#vision_chat — 2026-09-05
...
- 结果：HTTP 200；mode **live**；id `resp_09e284e86092e6d0016a9b7eea8e9887d0a129d2a99c9834a9`；usage prompt=23 completion=23 total=46；摘要 `Red`；3235ms
...
| reference_images | reference | 1 图 200 live（id `resp_09e284e86092e6d0016a9b7eea8e9887d0a129d2a99c9834a9`） | 2 图 200 live text=`2`；10 图 200 live text=`10`；**11 图仍 HTTP 200 live text=`11`，未触达拒绝点** | 上游未在 11 拒绝 → **不得写「最大 10 实测」**；契约 max:10 仅 `policy_conservative` |
